...
<title>Central de Reservas - Login</title>
...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
		...
		<form id="loginForm" action="/reservas/login" method="post">

			<h1 class="h5 mb-3 fw-normal">Central de Reservas - Sogo Hotel</h1>
			<hr>
			...
			<div align="center">
	           <div id="g_id_onload"
	                data-client_id="74882293755-9utmk5dspbs5c5d8hov4us26chbmerf2.apps.googleusercontent.com"
	                data-context="signin"
	                data-ux_mode="popup"
	                data-login_uri="http://localhost:8080/reservas/"
		...
		<a class="btn btn-link" href="/reservas/cliente/cadastrar" role="button">Não tem conta? Faça seu cadastro</a>
