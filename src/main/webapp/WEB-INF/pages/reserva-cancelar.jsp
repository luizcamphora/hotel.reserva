					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<form:form action="/reservas/reserva/cancelar/salvar" method="post" modelAttribute="reserva">
										...
										<div class="form-row">
											...
											<div class="row mb-4">
												...
												<div class="col-md-12">
													...
													<select class="form-select" id="select-reserva" name="id" required="required">
														<option value="">Selecione uma reserva</option> 
					 									<c:forEach var="reservaVar" items="${reservas}"> 
			 												<option value="${reservaVar.id}">${reservaVar.identificador}</option> 
					 									</c:forEach> 
					 								</select> 
												</div>
