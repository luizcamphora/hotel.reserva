				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12" align="right">
							<a href="novo" class="btn btn-primary">Adicionar</a>
						</div>
					</div>
				</div>
			</div>
										...
										<tbody>
											<c:forEach var="cliente" items="${listCliente}">
												<tr>
													...
													<td>${cliente.email}</td>
													<td>${cliente.login}</td>
													<td>${cliente.perfil.nome}</td>
													<td><a href="editar?id=${cliente.id}">Editar</a> | 
														<a href="deletar?id=${cliente.id}">Deletar</a> |
														<a href="editar-senha?id=${cliente.id}">Alterar Senha</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
