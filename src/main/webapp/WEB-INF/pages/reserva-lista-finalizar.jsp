						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Reservas Aguardando Finalização</h4>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											<c:forEach var="reserva" items="${listReserva}">
												<tr>
													...
													<td>${reserva.dataCheckInStr}</td>
													<td>${reserva.dataCheckOutStr}</td>
													<td>${reserva.status.nome}</td>
													<td><a href="finalizar?id=${reserva.id}">Finalizar</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
