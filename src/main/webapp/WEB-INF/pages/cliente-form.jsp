							...
							<div class="card">
								...
								<form:form action="salvar" method="post" modelAttribute="cliente">
										...
										<div class="form-row">
											...
											<div class="row mb-4">
												...
												<div class="col-md-3">
													...
													<select class="form-select" id="single-select-field" name="perfil.id" required="required">
														<option value="">Selecione um perfil</option> 
					 									<c:forEach var="perfilVar" items="${perfis}"> 
					 										<c:choose>
															    <c:when test="${cliente.perfil.id == perfilVar.id}">
											...
											<div class="row mb-4">
												...
												<div class="col-md-12">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="logradouro" name="endereco.logradouro" value="${cliente.endereco.logradouro}" required="required" />
													</div>
												</div>
											...
											<div class="row mb-4">
												...
												<div class="col-md-4">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="bairro" name="endereco.bairro" value="${cliente.endereco.bairro}" required="required" />
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="municipio" name="endereco.municipio" value="${cliente.endereco.municipio}" required="required" />
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="estado" name="endereco.estado" value="${cliente.endereco.estado}" required="required" />
													</div>
												</div>
											...
											<div class="row mb-4">
												...
												<div class="col-md-2">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="cep" name="endereco.cep" value="${cliente.endereco.cep}" required="required" />
													</div>
												</div>
												...
												<div class="col-md-10">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="complemento" name="endereco.complemento" value="${cliente.endereco.complemento}" />
													</div>
												</div>
												...
												<div class="row mb-4">
													<div class="col-md-6">
														<div class="form-outline">
															...
															<input type="text" class="form-control" id="login" name="login" value="${cliente.login}" required="required" />
														</div>
													</div>
													<div class="col">
														<div class="form-outline">
									...
									<div class="card-footer">
										...
										<a class="btn btn-secondary" href="/reservas/cliente/lista" role="button">Cancelar</a>
									</div>
