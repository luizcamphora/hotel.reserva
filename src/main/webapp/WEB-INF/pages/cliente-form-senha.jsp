					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<form:form action="salvar-senha" method="post" modelAttribute="cliente">
											...
											<div class="row mb-4">
												...
												<div class="col-md-9">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="nome" name="nome" value="${cliente.nome}" required="required" disabled="disabled" />
													</div>
												</div>
											...
											<div class="row mb-4">
												...
												<div class="col-md-3">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="cpf" name="cpf" value="${cliente.cpf}" required="required" 
															data-inputmask='"mask": "999.999.999-99"' data-mask disabled="disabled" />
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-outline">
														...
														<input type="email" class="form-control" id="email" name="email" value="${cliente.email}" required="required" disabled="disabled"/>
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-outline"> 
														...
														<input type="text" class="form-control" id="telefone" name="telefone" value="${cliente.telefone}" required="required" disabled="disabled" />
													</div>
												</div>
											...
											<div class="row mb-4">
												<div class="col-md-6">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="login" name="login" value="${cliente.login}" disabled="disabled" />
													</div>
												</div>
												<div class="col">
													<div class="form-outline">
