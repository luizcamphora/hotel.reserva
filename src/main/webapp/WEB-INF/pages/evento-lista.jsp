						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Eventos Cadastradas</h4>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<table id="table" class="table table-striped"
										...
										<tbody>
											<c:forEach var="evento" items="${listEvento}">
												<tr>
													<td>${evento.nome}</td>
													<td><a href="editar?id=${evento.id}">Editar</a> | <a
														href="deletar?id=${evento.id}">Deletar</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
