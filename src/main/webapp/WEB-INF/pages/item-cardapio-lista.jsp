							...
							<div class="card">
								...
								<div class="card-body">
									<table id="table" class="table table-striped"
										...
										<thead>
											<tr>
												<th width="80%">Prato</th>
												<th width="20%">Ações</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="itemCardapio" items="${listItemCardapio}">
												<tr>
													<td>${itemCardapio.prato}</td>
													<td><a href="editar?id=${itemCardapio.id}">Editar</a> | <a
														href="deletar?id=${itemCardapio.id}">Deletar</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
