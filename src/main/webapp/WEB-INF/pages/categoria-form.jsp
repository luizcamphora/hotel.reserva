					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<form:form action="salvar" method="post" modelAttribute="categoria">
											...
											<div class="row mb-4">
												<div class="col-md-12">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="nome" name="nome" value="${categoria.nome}" required="required"  />
													</div>
												</div>
											</div>
									...
									<div class="card-footer">
										...
										<a class="btn btn-secondary" href="/reservas/categoria/lista" role="button">Cancelar</a>
									</div>
