						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Grupos Cadastrados</h4>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<table id="table" class="table table-striped"
										...
										<tbody>
											<c:forEach var="grupoCardapio" items="${listGrupoCardapio}">
												<tr>
													<td>${grupoCardapio.nome}</td>
													<td><a href="editar?id=${grupoCardapio.id}">Editar</a> | <a
														href="deletar?id=${grupoCardapio.id}">Deletar</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
